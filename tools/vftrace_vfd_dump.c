...
void display_help () {
	printf ("Usage: vftrace_vfd_dump [OPTION] [VFD_FILE]\n");
	printf ("Display the content of the [VFD_FILE] generated by Vftrace.\n");
	printf ("\n");
	printf ("Options: \n");
	printf ("-i: Hide most output. Use to check if large files are healthy.\n");
