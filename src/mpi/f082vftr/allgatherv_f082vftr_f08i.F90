...
MODULE vftr_mpi_allgatherv_f082vftr_f08i
#ifdef _MPI
   ...
   INTERFACE 
      ...
      SUBROUTINE vftr_MPI_Allgatherv_f082vftr(sendbuf, sendcount, f_sendtype, &
         ...
         BIND(C, name="vftr_MPI_Allgatherv_f082vftr")
         IMPLICIT NONE
      ...
      END SUBROUTINE vftr_MPI_Allgatherv_f082vftr
...
END MODULE vftr_mpi_allgatherv_f082vftr_f08i
