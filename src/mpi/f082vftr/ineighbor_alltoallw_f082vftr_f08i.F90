MODULE vftr_mpi_ineighbor_alltoallw_f082vftr_f08i
#ifdef _MPI
   ...
   PUBLIC :: vftr_MPI_Ineighbor_alltoallw_f082vftr

   INTERFACE

      SUBROUTINE vftr_MPI_Ineighbor_alltoallw_f082vftr(sendbuf, f_sendcounts, &
                                                       f_sdispls, f_sendtypes, &
                                                       recvbuf, f_recvcounts, &
                                                       f_rdispls, f_recvtypes, &
                                                       f_comm, f_request, f_error) &
         BIND(C, name="vftr_MPI_Ineighbor_alltoallw_f082vftr")
      ...
      END SUBROUTINE vftr_MPI_Ineighbor_alltoallw_f082vftr
...
END MODULE vftr_mpi_ineighbor_alltoallw_f082vftr_f08i
