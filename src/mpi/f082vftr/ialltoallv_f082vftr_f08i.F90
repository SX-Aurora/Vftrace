...
MODULE vftr_mpi_ialltoallv_f082vftr_f08i
#ifdef _MPI
   ...
   PUBLIC :: vftr_MPI_Ialltoallv_f082vftr

   INTERFACE 

      SUBROUTINE vftr_MPI_Ialltoallv_f082vftr(sendbuf, f_sendcounts, f_sdispls, f_sendtype, &
                                              recvbuf, f_recvcounts, f_rdispls, f_recvtype, &
                                              f_comm, f_request, f_error) &
         BIND(C, name="vftr_MPI_Ialltoallv_f082vftr")
         IMPLICIT NONE
      ...
      END SUBROUTINE vftr_MPI_Ialltoallv_f082vftr
...
END MODULE vftr_mpi_ialltoallv_f082vftr_f08i
