...
void vftr_MPI_Ireduce_scatter_f082vftr(void *sendbuf, void *recvbuf,
   ...
   if (isintercom) {
      c_error = vftr_MPI_Ireduce_scatter_intercom(sendbuf,
                                                  recvbuf,
                                                  c_recvcounts,
                                                  c_datatype,
                                                  c_op,
      ...
      if (vftr_is_C_MPI_IN_PLACE(sendbuf)) {
         c_error = vftr_MPI_Ireduce_scatter_inplace(sendbuf,
                                                    recvbuf,
                                                    c_recvcounts,
                                                    c_datatype,
                                                    c_op,
         ...
         c_error = vftr_MPI_Ireduce_scatter(sendbuf,
                                            recvbuf,
                                            c_recvcounts,
                                            c_datatype,
                                            c_op,
