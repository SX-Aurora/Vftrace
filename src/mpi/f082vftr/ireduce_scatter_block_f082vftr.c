...
void vftr_MPI_Ireduce_scatter_block_f082vftr(void *sendbuf, void *recvbuf,
   ...
   if (isintercom) {
      c_error = vftr_MPI_Ireduce_scatter_block_intercom(sendbuf,
                                                        recvbuf,
                                                        (int)(*recvcount),
                                                        c_datatype,
                                                        c_op,
      ...
      if (vftr_is_C_MPI_IN_PLACE(sendbuf)) {
         c_error = vftr_MPI_Ireduce_scatter_block_inplace(sendbuf,
                                                          recvbuf,
                                                          (int)(*recvcount),
                                                          c_datatype,
                                                          c_op,
         ...
         c_error = vftr_MPI_Ireduce_scatter_block(sendbuf,
                                                  recvbuf,
                                                  (int)(*recvcount),
                                                  c_datatype,
                                                  c_op,
