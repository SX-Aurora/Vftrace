...
MODULE vftr_mpi_neighbor_allgather_f082vftr_f08i
#ifdef _MPI
   ...
   INTERFACE
      ...
      SUBROUTINE vftr_MPI_Neighbor_allgather_f082vftr(sendbuf, sendcount, f_sendtype, &
                                                      ...
                                                      f_comm, f_error) &
         BIND(C, name="vftr_MPI_Neighbor_allgather_f082vftr")
         IMPLICIT NONE
      ...
      END SUBROUTINE vftr_MPI_Neighbor_allgather_f082vftr
...
END MODULE vftr_mpi_neighbor_allgather_f082vftr_f08i
