...
void vftr_MPI_Ineighbor_alltoall_f082vftr(void *sendbuf, MPI_Fint *sendcount,
   ...
   switch(topology) {
      case MPI_GRAPH:
         c_error = vftr_MPI_Ineighbor_alltoall_graph(sendbuf,
                                                     (int)(*sendcount),
                                                     c_sendtype,
                                                     recvbuf,
                                                     (int)(*recvcount),
         ...
         break;
      case MPI_CART:
         c_error = vftr_MPI_Ineighbor_alltoall_cart(sendbuf,
                                                    (int)(*sendcount),
                                                    c_sendtype,
                                                    recvbuf,
                                                    (int)(*recvcount),
         ...
         break;
      case MPI_DIST_GRAPH:
         c_error = vftr_MPI_Ineighbor_alltoall_dist_graph(sendbuf,
                                                          (int)(*sendcount),
                                                          c_sendtype,
                                                          recvbuf,
                                                          (int)(*recvcount),
      ...
      case MPI_UNDEFINED:
      default:
         c_error = PMPI_Ineighbor_alltoall(sendbuf,
                                           (int)(*sendcount),
                                           c_sendtype,
                                           recvbuf,
                                           (int)(*recvcount),
