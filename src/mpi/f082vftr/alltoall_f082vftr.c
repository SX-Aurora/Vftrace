...
void vftr_MPI_Alltoall_f082vftr(void *sendbuf, MPI_Fint *sendcount, MPI_Fint *f_sendtype,
   ...
   if (isintercom) {
      c_error = vftr_MPI_Alltoall_intercom(sendbuf,
                                           (int)(*sendcount),
                                           c_sendtype,
                                           recvbuf,
                                           (int)(*recvcount),
      ...
      if (vftr_is_C_MPI_IN_PLACE(sendbuf)) {
         c_error = vftr_MPI_Alltoall_inplace(sendbuf,
                                             (int)(*sendcount),
                                             c_sendtype,
                                             recvbuf,
                                             (int)(*recvcount),
         ...
         c_error = vftr_MPI_Alltoall(sendbuf,
                                     (int)(*sendcount),
                                     c_sendtype,
                                     recvbuf,
                                     (int)(*recvcount),
