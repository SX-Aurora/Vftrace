...
MODULE vftr_mpi_rsend_init_f082vftr_f08i
#ifdef _MPI
   ...
   INTERFACE
      ...
      SUBROUTINE vftr_MPI_Rsend_init_f082vftr(buf, count, f_datatype, dest, tag, &
         ...
         BIND(C, name="vftr_MPI_Rsend_init_f082vftr")
         INTEGER :: buf
      ...
      END SUBROUTINE vftr_MPI_Rsend_init_f082vftr
...
END MODULE vftr_mpi_rsend_init_f082vftr_f08i
