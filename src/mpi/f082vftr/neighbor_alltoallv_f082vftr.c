...
void vftr_MPI_Neighbor_alltoallv_f082vftr(void *sendbuf, MPI_Fint *f_sendcounts,
   ...
   switch(topology) {
      case MPI_GRAPH:
         c_error = vftr_MPI_Neighbor_alltoallv_graph(sendbuf,
                                                     c_sendcounts,
                                                     c_sdispls,
                                                     c_sendtype,
                                                     recvbuf,
         ...
         break;
      case MPI_CART:
         c_error = vftr_MPI_Neighbor_alltoallv_cart(sendbuf,
                                                    c_sendcounts,
                                                    c_sdispls,
                                                    c_sendtype,
                                                    recvbuf,
         ...
         break;
      case MPI_DIST_GRAPH:
         c_error = vftr_MPI_Neighbor_alltoallv_dist_graph(sendbuf,
                                                          c_sendcounts,
                                                          c_sdispls,
                                                          c_sendtype,
                                                          recvbuf,
