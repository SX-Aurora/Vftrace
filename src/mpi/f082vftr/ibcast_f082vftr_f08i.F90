MODULE vftr_mpi_ibcast_f082vftr_f08i
#ifdef _MPI
   ...
   INTERFACE
      ...
      SUBROUTINE vftr_MPI_Ibcast_f082vftr(buffer, count, f_datatype, &
         ...
         BIND(C, name="vftr_MPI_Ibcast_f082vftr")
         IMPLICIT NONE
      ...
      END SUBROUTINE vftr_MPI_Ibcast_f082vftr
...
END MODULE vftr_mpi_ibcast_f082vftr_f08i
