MODULE vftr_sync_time_F
   ...
   INTERFACE
      ...
      SUBROUTINE vftr_estimate_sync_time_F2C(routine_name, comm) &
         BIND(c, NAME="vftr_estimate_sync_time_F2C")
         USE ISO_C_BINDING, ONLY : C_CHAR
         IMPLICIT NONE
         CHARACTER(KIND=C_CHAR), INTENT(IN) :: routine_name(*)
         INTEGER, INTENT(IN) :: comm
      END SUBROUTINE vftr_estimate_sync_time_F2C
...
CONTAINS
   ...
   SUBROUTINE vftr_estimate_sync_time(routine_name_F, comm)
      ...
      CALL vftr_estimate_sync_time_F2C(routine_name_C, comm)
      DEALLOCATE(routine_name_C)
   END SUBROUTINE vftr_estimate_sync_time

END MODULE vftr_sync_time_F
