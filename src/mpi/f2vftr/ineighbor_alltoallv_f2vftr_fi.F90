...
MODULE vftr_mpi_ineighbor_alltoallv_f2vftr_fi
#ifdef _MPI
   ...
   INTERFACE
      ...
      SUBROUTINE vftr_MPI_Ineighbor_alltoallv_f2vftr(SENDBUF, F_SENDCOUNTS, &
                                                     ...
                                                     F_COMM, F_REQUEST, &
                                                     F_ERROR) &
         BIND(C, name="vftr_MPI_Ineighbor_alltoallv_f2vftr")
         IMPLICIT NONE
         INTEGER SENDBUF
         ...
         INTEGER F_REQUEST
         INTEGER F_ERROR
      END SUBROUTINE vftr_MPI_Ineighbor_alltoallv_f2vftr
...
END MODULE vftr_mpi_ineighbor_alltoallv_f2vftr_fi
