MODULE vftr_mpi_alltoallv_f2vftr_fi
#ifdef _MPI
   ...
   INTERFACE
      ...
      SUBROUTINE vftr_MPI_Alltoallv_f2vftr(SENDBUF, F_SENDCOUNTS, F_SDISPLS, F_SENDTYPE, &
                                        ...
                                        F_COMM, F_ERROR) &
         BIND(C, name="vftr_MPI_Alltoallv_f2vftr")
         IMPLICIT NONE
         INTEGER SENDBUF
         ...
         INTEGER F_COMM
         INTEGER F_ERROR
      END SUBROUTINE vftr_MPI_Alltoallv_f2vftr
...
END MODULE vftr_mpi_alltoallv_f2vftr_fi
