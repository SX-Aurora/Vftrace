...
SUBROUTINE MPI_Neighbor_allgather_f08(sendbuf, sendcount, sendtype, &
                                      recvbuf, recvcount, recvtype, &
                                      comm, error)
   USE vftr_mpi_neighbor_allgather_f082vftr_f08i, &
      ONLY : vftr_MPI_Neighbor_allgather_f082vftr
   ...
   IF (vftr_no_mpi_logging_f08()) THEN
      CALL PMPI_Neighbor_allgather(sendbuf, sendcount, sendtype, &
                                   ...
                                   comm, tmperror)
   ELSE
      CALL vftr_MPI_Neighbor_allgather_f082vftr(sendbuf, sendcount, sendtype%MPI_VAL, &
