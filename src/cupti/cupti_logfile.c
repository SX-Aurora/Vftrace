...
void vftr_write_logfile_cupti_table(FILE *fp, collated_stacktree_t stacktree, config_t config) {
   int n_stackids_with_cupti_data = 0;

   collated_stack_t **sorted_stacks = vftr_sort_collated_stacks_for_cupti (config, stacktree);
