...
void vftr_register_dummy_cuda_stack (char *stackstring, int cbid, float t_ms,
   ...
   vftr_accumulate_cudaprofiling(&(profile->cudaprof), cbid, 1, t_ms, mem_dir, memcpy_bytes);
}
