// This test creates four artificial local stack trees on each rank. We print out the local unnormalized stacks and the corresponding normalized global stack list.
...
int main (int argc, char **argv) {
  ...
  // perform the stack normalization
