...
int main(int argc, char **argv) {
   ...
   vftr_new_profile(0,&(stacktree.stacks[func2_idx].profiling));
   ...
   vftr_new_profile(0,&(stacktree.stacks[func3_idx].profiling));
   ...
   vftr_new_profile(0,&(stacktree.stacks[func4_idx].profiling));
   ...
   vftr_new_profile(0,&(stacktree.stacks[func5_idx].profiling));
   ...
   vftr_new_profile(0,&(stacktree.stacks[func6_idx].profiling));
   ...
   vftr_new_profile(0,&(stacktree.stacks[func7_idx].profiling));
