...
int main (int argc, char **argv) {
   ...
   if (myrank == 0) {
      ...
      long long c3[] = {1000, 0};
      vftr_register_dummy_hwprof_stack (&dummy_stacktree, "hwfunc3<func0<init", c3);
   }
   ...
   for (int i = 0; i < nranks; i++) {
      if (myrank == i) {
        ...
        vftr_write_ranklogfile_hwprof_counter_table(stdout, dummy_stacktree, vftrace.config);
      }
      fflush(stdout);
