PROGRAM iallgather_intercom
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./iallgather_intercom <msgsize in integers>"
      STOP 1
   END IF
   ...
   CALL MPI_IallGather(sbuffer, nints, MPI_INTEGER, &
...
END PROGRAM iallgather_intercom
