PROGRAM ineighbor_alltoallw_cart_periodic
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./ineighbor_alltoallw_cart_periodic <msgsize in integers>"
      STOP 1
   END IF
   ...
   ! Message cycle
   CALL MPI_Ineighbor_alltoallw(sbuffer, sendcounts, sdispls, sendtypes, &
...
END PROGRAM ineighbor_alltoallw_cart_periodic
