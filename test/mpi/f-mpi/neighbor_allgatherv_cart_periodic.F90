PROGRAM neighbor_allgatherv_cart_periodic
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./neighbor_allgatherv_cart_periodic <msgsize in integers>"
      STOP 1
   END IF
...
END PROGRAM neighbor_allgatherv_cart_periodic
