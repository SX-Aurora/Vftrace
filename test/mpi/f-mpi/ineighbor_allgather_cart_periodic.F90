PROGRAM ineighbor_allgather_cart_periodic
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./ineighbor_allgather_cart_periodic <msgsize in integers>"
      STOP 1
   END IF
...
END PROGRAM ineighbor_allgather_cart_periodic
