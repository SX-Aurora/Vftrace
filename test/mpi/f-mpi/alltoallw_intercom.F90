PROGRAM alltoallw_intercom
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./alltoallw_intercom <msgsize in integers>"
      STOP 1
   END IF
   ...
   CALL MPI_Alltoallw(sbuffer, scounts, sdispls, stypes, &
...
END PROGRAM alltoallw_intercom
