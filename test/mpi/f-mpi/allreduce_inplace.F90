PROGRAM allreduce_inplace
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./allreduce_inplace <msgsize in integers>"
      STOP 1
   END IF
   ...
   ! Message cycle
   CALL MPI_Allreduce(MPI_IN_PLACE, rbuffer, nints, MPI_INTEGER, &
