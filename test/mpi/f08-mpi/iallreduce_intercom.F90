PROGRAM iallreduce_intercom
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./iallreduce_intercom <msgsize in integers>"
      STOP 1
   END IF
   ...
   CALL MPI_Iallreduce(sbuffer, rbuffer, nints, MPI_INTEGER, &
...
END PROGRAM iallreduce_intercom
