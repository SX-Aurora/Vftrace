PROGRAM alltoall_intercom
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./alltoall_intercom <msgsize in integers>"
      STOP 1
   END IF
   ...
   CALL MPI_Alltoall(sbuffer, nints, MPI_INTEGER, &
