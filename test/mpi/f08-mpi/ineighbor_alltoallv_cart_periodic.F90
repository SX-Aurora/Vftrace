PROGRAM ineighbor_alltoallv_cart_periodic
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./ineighbor_alltoallv_cart_periodic <msgsize in integers>"
      STOP 1
   END IF
...
END PROGRAM ineighbor_alltoallv_cart_periodic
