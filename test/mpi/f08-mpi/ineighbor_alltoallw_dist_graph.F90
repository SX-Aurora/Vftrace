PROGRAM ineighbor_alltoallw_dist_graph
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./ineighbor_alltoallw_dist_graph <msgsize in integers>"
      STOP 1
   END IF
...
END PROGRAM ineighbor_alltoallw_dist_graph
