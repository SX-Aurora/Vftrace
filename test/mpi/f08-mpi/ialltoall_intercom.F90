PROGRAM ialltoall_intercom
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./ialltoall_intercom <msgsize in integers>"
      STOP 1
   END IF
...
END PROGRAM ialltoall_intercom
