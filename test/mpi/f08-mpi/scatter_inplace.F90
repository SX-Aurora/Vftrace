PROGRAM scatter_inplace
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./scatter_inplace <msgsize in integers>"
      STOP 1
   END IF
   ...
   ELSE
      CALL MPI_Scatter(sbuffer, 0, MPI_DATATYPE_NULL, &
