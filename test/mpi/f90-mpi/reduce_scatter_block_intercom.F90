PROGRAM reduce_scatter_block_intercom
   ...
   IF (COMMAND_ARGUMENT_COUNT() < 1) THEN
      WRITE(UNIT=OUTPUT_UNIT, FMT="(A)") "./reduce_scatter_block_intercom <msgsize in integers>"
      STOP 1
   END IF
   ...
   CALL MPI_Reduce_scatter_block(sbuffer, rbuffer, recvcount, MPI_INTEGER, &
...
END PROGRAM reduce_scatter_block_intercom
